...
describe('bem test', () => {
  ...
  describe('block with prefix', () => {
    ...
    it('with array of string modifiers', () => {
      expect(bem(null, modifiers)).toEqual(
        `${prefix}${block} ${prefix}${block}--${modifiers[0]} ${prefix}${block}--${modifiers[1]}`,
      )
    })
    ...
    it('with element & single string modifier & single string util', () => {
      expect(bem(element, modifier, util)).toEqual(
        `${prefix}${block}__${element} ${prefix}${block}__${element}--${modifier} ${util}`,
      )
    })
